...
const Gallery = () => {
  ...
  return (
    ...
    <h1 className={`text-[24px] font-poppins font-bold text-heading leading-[30.8px]`}>{t("Achievers Archive")}</h1>
    <p className={`text-xs my-2 text-justify xs:text-xs text-gray-500 
    sm:text-base md:text-sm lg:text-base xl:text-xl`}>
    {t("At our esteemed establishment, we believe in going above and beyond to ensure your stay surpasses all expectations")}.</p>  
    </div>
